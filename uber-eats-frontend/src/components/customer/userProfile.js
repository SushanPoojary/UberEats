...
class userProfile extends Component {
  displayItems() {
    ...
    if (data.loading) {
      ...
      console.log(data.userDeets.name);
      return (
        <div>
              ...
              <div className="row">
                ...
                <div className="col-xs">
                  <OverallText>
                    Country
                    <br />
                    <input type="text" name="state" defaultValue={data.userDeets.country} placeholder=" Country " style={{ width: '390px', height: '35px' }} onChange={(val) => this.selectCountry(val)} required />
                    <br />
                  </OverallText>
                </div>
              </div>
              ...
              {/* <div className="row">
                ...
                <div className="col-xs">
                  <OverallText>
                    Profile Image
                    <br />
                    <input type="file" name="picture" defaultValue={data.userDeets.picture} onChange={this.handleFileChange} required />
                    <br />
                    {data.userDeets.preview && (<img src={data.userDeets.preview} alt="chosen" style={{ height: '200px' }} />)}
                    <Image
      ...
      //   {data.userDeets.contact}
      //   <strong>[Email]: </strong>
      //   {data.userDeets.email}
      // )
      // return data.userDeets.map((item, i) => {
      //   return (
      //     <li key={i}>
      //       <strong>[Name]: </strong>
      //       {item.name}
...
export default graphql(getUserQuery)(userProfile);
