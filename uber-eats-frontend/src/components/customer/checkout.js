...
class checkout extends React.Component {
  ...
  componentDidMount() {
    ...
    Axios.defaults.withCredentials = true;
    Axios.defaults.headers.common['authorization'] = localStorage.getItem('token');
    Axios.get('http://54.153.48.19:3001/getPrice')
      .then((res) => {
        if (res) {
          console.log(res.data);
    ...
    Axios.defaults.withCredentials = true;
    Axios.defaults.headers.common['authorization'] = localStorage.getItem('token');
    Axios.get('http://54.153.48.19:3001/getUserDeets')
      .then((res) => {
        if (res) {
  ...
  updateProfile = (data) => {
    Axios.defaults.withCredentials = true;
    Axios.defaults.headers.common['authorization'] = localStorage.getItem('token');
    Axios.post('http://54.153.48.19:3001/updateordProfile', data)
      .then((res) => {
        if (res) {
          console.log('Updated');
        }
  ...
  handleSubmit = (event) => {
    ...
    Axios.defaults.withCredentials = true;
    Axios.defaults.headers.common['authorization'] = localStorage.getItem('token');
    Axios.post('http://54.153.48.19:3001/order', products)
      .then((response) => {
    ...
    Axios.defaults.withCredentials = true;
    Axios.defaults.headers.common['authorization'] = localStorage.getItem('token');
    Axios.post('http://54.153.48.19:3001/cartorder', products)
      .then((response) => {
        console.log('Status Code : ', response.status);
        console.log(response);
        const status = response.status;
  ...
  handleDelete = (event) => {
    ...
    Axios.defaults.withCredentials = true;
    Axios.defaults.headers.common['authorization'] = localStorage.getItem('token');
    Axios.post('http://54.153.48.19:3001/deletefromcart', visitdata)
      .then((res) => {
  ...
  updateIns() {
    ...
    Axios.defaults.withCredentials = true;
    Axios.defaults.headers.common['authorization'] = localStorage.getItem('token');
    Axios.post('http://54.153.48.19:3001/orderIns', SplInv)
      .then((response) => {
        console.log('Status Code : ', response.status);
        console.log(response);
        const status = response.status;
