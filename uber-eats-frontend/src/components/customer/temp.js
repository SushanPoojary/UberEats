...
//   }
  ...
  // }
    ...
    console.log(data);
  //   this.setState({
  //     name: data.userDeets.name,
  //     add1: data.userDeets.add1,
  //     add2: data.userDeets.add2,
  //     location: data.userDeets.location,
  //     state: data.userDeets.state,
  //     country: data.userDeets.country,
  //     nickname: data.userDeets.nickname,
  //     dob: data.userDeets.dob,
  //     about: data.userDeets.about,
  //     email: data.userDeets.email,
  //     contact: data.userDeets.contact,
  //     // picture: this.userDeets.picture,
  //     // preview: this.userDeets.preview,
  //     uploadPublicID: data.userDeets.uploadPublicID,
  //   });
